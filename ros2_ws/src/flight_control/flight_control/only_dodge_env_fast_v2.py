# only_dodge_env_fast_v2.py
# - reset(): REALTIME (wall-clock) pacing restored for robust Offboard/Arm/Takeoff.
# - step(): remains FAST (sim-time via VehicleOdometry.timestamp_sample) so PX4_SIM_SPEED_FACTOR can accelerate training.
# Safe to use alongside original: does not overwrite any files.
...
class OnlyDodgeEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        print("\n>>> Resetting Environment (Only Dodge Mode, FAST v2: realtime reset)...")
        ...
        self.last_odom_ts_us = None  # reset odom time anchor for fast stepping
